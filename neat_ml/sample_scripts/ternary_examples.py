...
df = pd.read_excel(
    "neat_ml/data/Hypothetical_ternary_phase_map.xlsx", sheet_name=[0, 1], header=1
)
...
for df_it, y, plot_name in zip(
    [df_80_pt_wat, df_20_pt_wat],
...
X = np.array([[50, 20, 30], [10, 60, 30], [10, 30, 60]])
y = np.ones(3)
actual_fig = lib.plot_tri_phase_diagram(
    X=X,
    y=y,
